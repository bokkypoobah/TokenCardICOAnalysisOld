...
var tknTokenBalanceBlock = parseInt(icoFirstTxBloc) + 1000;
icoLastTxBlock = parseInt(icoFirstTxBlock) + 10;
...
filter.watch(function(e, r) {
  ...
  if (toAddress == icoAddress) {
    ...
    var tokenBalance = tknToken.balanceOf(fromAddress, tknTokenBalanceBlock);
